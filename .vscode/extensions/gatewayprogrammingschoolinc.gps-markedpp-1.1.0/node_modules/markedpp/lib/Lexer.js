...
Lexer.prototype.token = function (src, top) {
  var cap, bull, next, l, b, i, item, space, loose, bq, tmp, opts;
  ...
  while (src) {
    ...
    if (cap = this.rules.list.exec(src)) {
      ...
      for (; i < l; i++) {
        item = cap[i];
        bull = this.rules.bullet.exec(item)[0]; // Remove the list item's bullet
